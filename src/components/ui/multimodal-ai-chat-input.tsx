    ...
    return (
        <textarea
            className={cn(
                ...
                'flex min-h-[80px] w-full rounded-md border border-gray-400 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-base ring-offset-white placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-600 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm text-slate-900 dark:!text-white',
                className,
            )}
            ref={ref}
            {...props}
            ...
            <div className="relative">
                <Textarea
                    ...
                    className={cn(
                        ...
                        'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm transition-all focus:border-indigo-400 dark:focus:border-indigo-500 focus:shadow-indigo-100/20 dark:focus:shadow-none text-slate-900 dark:!text-white',
                        className,
                    )}
                    rows={1}
                    autoFocus
